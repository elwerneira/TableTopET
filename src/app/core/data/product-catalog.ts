...
export const PRODUCT_CATALOG: Product[] = [
  ...
  { id: 'pokemon-tcg-inicial', nombre: 'Pokémon TCG - Collector Bundle (Spring 2022)', aliases: ['Pokemon TCG Collector Bundle', 'Collector Bundle Spring 2022'], precio: 28990, precioOriginal: 35990, imagen: '/img/pokemon-tcg-1.jpg', categoria: 'TCG', oferta: 'Oferta 19%', stock: 10, estado: 'activo' },
  { id: 'magic-kit-inicio', nombre: 'Pokémon TCG - Scarlet & Violet: Journey Together', aliases: ['Pokemon TCG Journey Together', 'Scarlet and Violet Journey Together'], precio: 59990, imagen: '/img/pokemon-tcg-2.jpg', categoria: 'TCG', stock: 10, estado: 'activo' },
  { id: 'yugioh-starter-deck', nombre: 'Pokémon - Mega Battle Deck - Mega Diancie', aliases: ['Pokemon Mega Battle Deck Mega Diancie', 'Mega Diancie'], precio: 34990, imagen: '/img/pokemon-tcg-3.jpg', categoria: 'TCG', stock: 10, estado: 'activo' },
];
