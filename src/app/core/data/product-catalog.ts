...
export const PRODUCT_CATALOG: Product[] = [
  ...
  { id: 'pokemon-tcg-inicial', nombre: 'Pokemon TCG Coleccion Inicial', aliases: ['Pokemon TCG Coleccion Inicial', 'Pokémon TCG - Colección inicial'], precio: 22490, precioOriginal: 24990, imagen: '/img/tcg-pokemon.png', categoria: 'TCG', oferta: 'Oferta 10%', stock: 10, estado: 'activo' },
  { id: 'magic-kit-inicio', nombre: 'Magic Kit de Inicio', aliases: ['Magic Kit de Inicio', 'Magic - Kit de inicio'], precio: 24990, imagen: '/img/tcg-magic.png', categoria: 'TCG', stock: 10, estado: 'activo' },
  { id: 'yugioh-starter-deck', nombre: 'Yu-Gi-Oh Starter Deck', aliases: ['Yu-Gi-Oh Starter Deck', 'Yu-Gi-Oh! - Starter Deck'], precio: 17990, imagen: '/img/tcg-yugioh.png', categoria: 'TCG', stock: 10, estado: 'activo' },
];
